...
* 4.4.4: Stable and recommended version.
...
* 4.4.4/configure.ac: configure generator.
* 4.4.4/Makefile.in: Makefile generator.
* 4.4.4/config.h.in: config header generator.
* 4.4.4/\*.c: source code files.
* 4.4.4/\*.h: header code files.
* 4.4.4/mpcotool.ico: icon file.
* 4.4.4/build.sh: shell script to build all.
* 4.4.4/logo.png: logo figure.
* 4.4.4/Doxyfile: configuration file to generate doxygen documentation.
* TODO: tasks to do.
* README.md: this file.
...
you are in the directory mpcotool/4.4.4):
> $ cd ../tests/test2
>
> $ ln -s ../../../genetic/3.0.1 genetic
>
