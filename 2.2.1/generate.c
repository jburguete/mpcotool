...
char *methodA1[NMETHODSA1] = {
  ...
  "mc-100-25-10-0.1-14",
  "mc-2500-1-14",
  "mc-c-100-1-600-0.1-1-14",
  "mc-c-1600-1-225-0.01-1-14",
...
char *methodB1[NMETHODSB1] = {
  "mc-100-25-4-0-14",
  "mc-c-100-1-600-0.01-0-14",
  "mc-c-100-1-600-0.01-1-14",
  "mc-c-100-1-600-0.01-2-14",
  "mc-c-100-1-600-0.1-0-14",
  "mc-c-100-1-600-1-0-14",
  "mc-ra-100-1-800-3-0.1-1-14",
...
char *methodA2[NMETHODSA2] = {
  ...
  "sw-50-50-1-14",
  "sw-c-10-10-1-600-0.1-1-14",
  "sw-c-40-40-1-225-0.01-1-14"
};
  ...
  for (i = 0; i < NTESTS; ++i)
    {
      for (j = 0; j < NMETHODSA1; ++j)
        for (k = 0; k < NSEEDS; ++k)
          fprintf (file, "./process test%s/variables-%s-%u test%s/v-%s-%u %s\n",
