...
Monte-Carlo brute force method with two variables for $N_{simulaciones}= 25$,
...
\PSPICTURE{-100}{-130}{100}{-15}
{
	...
	\rput(0,-20){Generation of $N_{simulaciones}$ empirical parameters sets}
	\psframe(-60,-25)(60,-10)
	\psline{->}(0,-25)(-60,-30)
	\psline{->}(0,-25)(0,-30)
	\psline{->}(0,-25)(60,-30)
	\rput(-60,-35){1st task:}
	\rput(-60,-40){$N_{simulaciones}/N_{tasks}$ simulations}
