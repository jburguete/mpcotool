...
generados por el algoritmo de optimización. Has dos opciones: o bien el programa
simulador compara directamente los resultados de la simulación con el
\emph{fichero de datos experimantales} y genera un fichero con el valor de la
...
$o_i$. El valor final de la función objetivo asociado al conjunto de
experimentos es calculado como:
\EQ
{
...
\emph{ficero de entrada principal}. En la figura~\ref{FigStructure} puede verse
