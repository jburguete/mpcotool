...
interfaz gráfica de usuario interactiva, llamada \emph{MPCOTool}. En la
...
MPCOTool genera un fichero denominado \emph{result} donde se guarda la mejor
