...
\item FreeBSD 10;
\item Microsoft Windows 7\footnotemark[1] and 8.1\footnotemark[1];
\item NetBSD 7.0;
\item OpenBSD 5.8;
\item OpenSUSE Linux 13;
\item and Ubuntu Linux 12, 14 and 15.
\end{itemize}
...
On Fedora Linux 23, in order to use OpenMPI compilation, do in a terminal (in 64
bits version):
\begin{lstlisting}[language=bash,basicstyle=\scriptsize]
...
\begin{description}
	...
	\item[gradient\_method]: method to estimate the gradient (optional for sweep
		and Monte-Carlo algorithms). Two values are currently available:
	\begin{description}
		\item[coordinates]: coordinates descent estimate.
		\item[random]: random estimate. It requieres:
		\begin{description}
			\item[nestimates]: number of random checks to estimate the gradient.
		\end{description}
	\end{description}
	Both methods requires the following parameters:
	\begin{description}
		\item[nsteps]: number of steps to perform the gradient based method,
		\item[relaxation]: relaxation parameter for the gradient based method,
	\end{description}
	and for each variable:
	\begin{description}
		\item[step]: initial step size for the gradient based method.
	\end{description}
...
value $o_i$ is obtained. The final value of the objective function associated
with the experiments set is calculated by means of:
\EQ
{
...
\PSPICTURE{-25}{-95}{280}{55}
{
	...
	\psframe(-25,20)(45,30)
	\psline{->}(45,25)(55,25)
	\psline[linestyle=dotted,dotsep=1pt]{->}(55,25)(90,25)
	\rput(10,15){$\cdots$}
	\rput(10,5){$n$-th template file}
	\psframe(-25,0)(45,10)
	\psline{->}(45,5)(55,5)
	\psline[linestyle=dotted,dotsep=1pt]{->}(55,5)(90,5)
	\rput(10,-35){$\cdots$}
	\rput(10,-75){$(N\times n)$-th template file}
	\psframe(-25,-70)(45,-80)
	\psline{->}(45,-75)(55,-75)
	\psline[linestyle=dotted,dotsep=1pt]{->}(55,-75)(90,-75)
	\rput(72.5,50){MPCOTool}
	\psframe(55,-95)(90,55)
	\psline{->}(90,25)(100,25)
	\psline{->}(90,5)(100,5)
	\psline{->}(90,-55)(100,-55)
	...
	\psline[linestyle=dotted,dotsep=1pt]{->}(90,-90)(55,-90)
	\psline{->}(60,-90)(45,-90)
	\rput(10,-90){Objective function value}
	\psframe(-25,-95)(45,-85)
