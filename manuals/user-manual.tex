...
graphical user interface application, called \emph{Calibrator}. In the
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=9.30cm]{calibrator-en.eps}
	\caption{Main window of Calibrator graphical user interface application.
		\label{FigWindow}}
\end{figure}
...
\begin{figure}[ht!]
	...
	\caption{Results dialog of Calibrator graphical user interface application.
		\label{FigResult}}
\end{figure}
...
variables and the corresponding calculated error, as well as the calculation
time, are saved.
