...
\item[Random (R)]: the vectors $\vec{t}_j$ are built randomly as:
\EQ
{
	\vec{t}_j=\MATRIX{c}{\PA{1-2\,r_{j,1}}\,st_1\\\vdots\\
	\PA{1-2\,r_{j,k}}\,st_k\\\vdots\\\PA{1-2\,r_{j,N_v}}\,st_{N_v}},
}{EqtRandom}
...
\FIGIII{sphere-evolution-ga-1-4.eps}{sphere-evolution-ga-5-8.eps}
{sphere-evolution-ga-9-11.eps}{Convergencia de la optimizacion de $g_{Sphere}$
con el algoritmo genético y distintas combinaciones de parametros}{FigSphereGA}
