...
\TABLE{\scriptsize}{cccc}
{
	...
	\\ algorithm & parameters & parameters & function value
	\\ \hline
	SW & $N_s=10000$ & $\overline{\alpha_{start}}=180.200^\circ$
	& 104.98
	\\ & & $\overline{\alpha_{stop}}=179.778^\circ$
	\\ & & $\delta=0.133^\circ$
	\\ & & $\tau=2.78$s
	\\ \hline
	SW+IT & $N_s=625$ & $\overline{\alpha_{start}}=179.744^\circ$
	& 94.34
	\\ & $N_i=16$ & $\overline{\alpha_{stop}}=179.344^\circ$
	\\ & $N_b=10$ & $\delta=0.118^\circ$
	\\ & $tol=0.4$ & $\tau=3.94$s
	\\ \hline
	MC & $N_s=10000$
	& $\overline{\alpha_{start}}=180.177^\circ$ & 109.92
	\\ & $N_i=1$ & $\overline{\alpha_{stop}}=179.768^\circ$
	\\ & & $\delta=0.139^\circ$
	\\ & & $\tau=3.77$s
	\\ \hline
	MC+IT & $N_s=625$
	& $\overline{\alpha_{start}}=179.786^\circ$ & 97.42
