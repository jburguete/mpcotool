...
\TABLE{\scriptsize}{ccc}
{
	...
	SW+RA-2 & SW+GB+RA & $N_x=N_y=10$, $N_{st}=600$, $st_x=st_y=0.1$, $rel=1$,
		$N_e=4$ \\
	SW+RA-3 & SW+GB+RA & $N_x=N_y=10$, $N_{st}=600$, $st_x=st_y=0.1$, $rel=1$,
		$N_e=8$ \\
	SW+RA-4 & SW+GB+RA & $N_x=N_y=40$, $N_{st}=225$, $st_x=st_y=0.01$,
		$rel=1$, $N_e=2$ \\
	SW+RA-5 & SW+GB+RA & $N_x=N_y=40$, $N_{st}=225$, $st_x=st_y=0.01$,
		$rel=1$, $N_e=4$ \\
	SW+RA-6 & SW+GB+RA & $N_x=N_y=40$, $N_{st}=225$, $st_x=st_y=0.01$,
		$rel=1$, $N_e=8$ \\
	MC-1 & MC & $N_s=2500$ \\
	...
	MC+RA-3 & MC+GB+RA & $N_s=100$, $N_{st}=600$, $st_x=st_y=0.1$, $rel=1$,
		$N_e=8$ \\
	MC+RA-4 & MC+GB+RA & $N_x=1600$, $N_{st}=225$, $st_x=st_y=0.01$, $rel=1$,
		$N_e=2$ \\
	MC+RA-5 & MC+GB+RA & $N_x=1600$, $N_{st}=225$, $st_x=st_y=0.01$, $rel=1$,
		$N_e=4$ \\
	MC+RA-6 & MC+GB+RA & $N_x=1600$, $N_{st}=225$, $st_x=st_y=0.01$, $rel=1$,
		$N_e=8$ \\
