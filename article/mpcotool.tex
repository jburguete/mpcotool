...
método MC+DS+RA. Se ha separado con una línea vertical el momento en el que
finaliza el algoritmo inicial MC del algoritmo DS+RA. En este caso MC realiza
768 simulaciones, repartiendo 12 en cada uno de los 64 núcleos utilizados, lo
que permite una paralelización bastante equilibrada, manteniendo una media de
60.3 núcleos activos y realizando casi 70 simulaciones por hora. Al final,
algunos núcleos finalizan sus simulaciones antes que otros, por lo que se van
inactivando núcleos hasta completar el cálculo. Aproximadamente a las 11 horas
de cálculo comienza el algoritmo DS+RA ejecutando 64 sumulaciones (sólo una por
núcleo) e iterando 4 veces el proceso. De media este algoritmo sólo logra
mantener 41.2 núcleos activos realizando menos de 40 simulaciones por hora. Este
peor resultado de la paralelización se debe a que las simulaciones más lentas y
más rápidas se compesan más ejecutando 12 simulaciones que una por núcleo. El
algoritmo en conjunto ha mantenido de media 52.7 núcleos activos y ha tardado
algo más de 18 horas en realizar las 1024 simulaciones, siendo uno de los más
lentos de todos los algoritmos utilizados.
\PLOT{load-swigs-mc-ra-768-1-64-4.eps}
{Evolución temporal del número de núcleos activos ejecutando la optimización
con MC+DS+RA. Con una línea vertical se marca el instante de tiempo en el que
finaliza el algoritmo MC y comienza el DS+RA}{FigSwigsLoad}
