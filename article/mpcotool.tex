...
\TABLE{\scriptsize}{cccc}
{
	...
	\\ algorithm & parameters & parameters & value
	\\ \hline
	MC & $N_s=3000$ & $n=0.0444$ & 0.6971
	\\ & $N_i=1$ & $K=9.690\cdot 10^{-4}$
	\\ & & $a=0.503$
	\\ \hline
	MC+IT & $N_s=500$ & $n=0.0420$ & 0.6903
	\\ & $N_i=6$ & $K=10.147\cdot 10^{-4}$
	\\ & $N_b=10$ & $a=0.504$
	\\ & $tol=0.2$
	\\ \hline
	MC+RA & $N_s=2200$ & $n=0.0421$ & 0.6928
	\\ & $N_i=1$ & $K=9.712\cdot 10^{-4}$
	\\ & $N_{st}=200$ & $a=0.512$
	\\ & $N_e=4$
	\\ & $st_n=0.0010$
	\\ & $st_K=10^{-6}$
	\\ & $st_a=0.010$
	\\ \hline
	GE & $N_p=750$ & $n=0.0413$ & 0.6930
	\\ & $N_g=6$ & $K=9.823\cdot 10^{-4}$
	\\ & $R_m=0.2$ & $a=0.508$
	\\ & $R_r=0.2$
	\\ & $R_a=0.2$
	\\ \hline
	GE & $N_p=300$ & $n=0.0420$ & 0.6918
	\\ & $N_g=31$ & $K=9.903\cdot 10^{-4}$
	\\ & $R_m=0.1$ & $a=0.508$
	\\ & $R_r=0.1$
	\\ & $R_a=0.1$
	\\ \hline
