...
\citep{MPCOToolGit,MPCOTool}, a software to perform optimization or calibration
of empirical parameters required in simulation models, is presented. It 
implements one genetic algorithm, two brute force algorithms (sweep and
Monte-Carlo) and, to improve the brute force methods, one iterative algorithm
and two direction search algorithms. The software is open source with a BSD type
license. All input data files used in the manuscript are also free and they can
be downloaded in the cited web pages.
