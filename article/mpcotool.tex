...
{Optimizacion de $g_{Sphere}$ con (left) el algoritmo de barrido and (right)
Monte-Carlo combinados ambos con el algoritmo iterativo y distintos parametros}
{FigSphereSWMC}

\FIGIII{sphere-evolution-ga-1-4.eps}{sphere-evolution-ga-5-8.eps}
{sphere-evolution-ga-9-11.eps}{Optimizacion de $g_{Sphere}$ con el algoritmo
genético y distintas combinaciones de parametros}{FigSphereGA}
