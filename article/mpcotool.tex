...
Genetic method bases have been established in \citet{Holland75}. MPCOTool also
offers the use of a genetic method Genetic \citep{genetic} with its default
algorithms. It is inspired on the ideas in \citet{gaul}, but it has been fully
reprogrammed involving more modern external libraries. The code in Genetic is
also open source under a BSD license.
...
Aproximadamente a las 11 horas de cálculo comienza el algoritmo DS+RA ejecutando
64 sumulaciones (sólo una por núcleo) e iterando 4 veces el proceso. De media
este algoritmo sólo mantiene 41.2 núcleos activos. Este peor resultado de la
paralelización se deba a que las simulaciones más lentas y más rápidas se
compesan más ejecutando 12 simulaciones que una por núcleo. El algoritmo en
conjunto a mantenido de media 52.7 núcleos activos.
