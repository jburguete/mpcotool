...
those obtained with the iterative and direction search methods. 
...
convergence of DS for the sphere function is higher using a lower number of
...
the DS for a fast convergence. As regards the method to estimate the direction,
