...
\TABLE{\scriptsize}{cccc}
{
	...
	\\ algorithm & parameters & parameters & function value
	\\ \hline
	SW & $N_x=10$ & $\overline{\alpha_{start}}=179.911^\circ$
	& 53.052
	\\ & & $\overline{\alpha_{stop}}=180.300^\circ$
	\\ & & $\delta=0.133^\circ$
	\\ & & $\tau=4.44$ s
	\\ \hline
	SW+IT & $N_x=5$ & $\overline{\alpha_{start}}=179.583^\circ$
	& 52.906
	\\ & $N_i=16$ & $\overline{\alpha_{stop}}=179.983^\circ$
	\\ & $N_b=10$ & $\delta=0.134^\circ$
	\\ & $tol=0.4$ & $\tau=4.30$ s
	\\ \hline
	MC & $N_s=10000$
	& $\overline{\alpha_{start}}=179.768^\circ$ & 56.788
	\\ & $N_i=1$ & $\overline{\alpha_{stop}}=180.177^\circ$
	\\ & & $\delta=0.139^\circ$
	\\ & & $\tau=3.77$s
	\\ \hline
	MC+IT & $N_s=625$
	& $\overline{\alpha_{start}}=179.786^\circ$ & 49.350
	\\ & $N_i=16$ & $\overline{\alpha_{stop}}=180.194^\circ$
	\\ & $N_b=10$ & $\delta=0.122^\circ$
	\\ & $tol=0.1$ & $\tau=3.82$s
	\\ \hline
	MC+DS+CD & $N_s=9000$, $N_{st}=125$
	& $\overline{\alpha_{start}}=179.768^\circ$ & 53.026
	\\ & $rel=1$ & $\overline{\alpha_{stop}}=180.174^\circ$
	\\ & $st_{\overline{\alpha_{start}}}=0.4$ & $\delta=0.139^\circ$
	\\ & $st_{\overline{\alpha_{stop}}}=0.3$ & $\tau=3.77$s
	\\ & $st_\delta=0.004$
	\\ & $st_\tau=0.05$
	\\ \hline
	GE & $N_p=1000$ & $\overline{\alpha_{start}}=179.800^\circ$
	& 49.947
	\\ & $N_g=16$ & $\overline{\alpha_{stop}}=180.190^\circ$
	\\ & $R_m=R_r=R_a=0.2$ & $\delta=0.137^\circ$
	\\ & & $\tau=4.39$s
	\\ \hline
	GE & $N_p=400$ & $\overline{\alpha_{start}}=179.979^\circ$
	& 49.862
	\\ & $N_g=81$ & $\overline{\alpha_{stop}}=180.374^\circ$
	\\ & $R_m=R_r=R_a=0.1$ & $\delta=0.129^\circ$
	\\ & & $\tau=4.28$s
	\\ \hline
