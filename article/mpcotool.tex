...
Fig.~\ref{FigPivotVelocity} the towers velocity is presented at an interval of
central working time.
\FIG{pivot-velocity.eps}
{Towers velocity in an interval of ten minutes at central working times for the
pivot working at 25\% velocity}{FigPivotVelocity}
%%%%%%%%%%%%%%%%%%%%
