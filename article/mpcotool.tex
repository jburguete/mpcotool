...
with a gradient based algorithm. Defining the vector $\vec{r}_i$ as the optimum
combination of variables obtained in the $i$-th step, $\vec{r}_1$ as the vector of the 
optimum combination of variables obtained by the brute force method and defining
...
relaxation parameter, the gradient based method checks $N_e$ 
combinations of variables and choice the optimum as:
\EQ
{
