...
\FIGIV{sphere-evolution-mc-cd-r.eps}{sphere-evolution-mc-r2.eps}
{sphere-evolution-mc-cd-s.eps}{sphere-evolution-mc-r.eps}
...
{Parameters combination simulated by diferent algorithms.}
{FigSphereParameters}
