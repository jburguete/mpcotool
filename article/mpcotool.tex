...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
El programa muestra una gran facilidad de uso y de adaptación para resolver
diferentes problemas de optimización/calibración  realizando de forma automática
para el usuario una paralelización para utilizar todos los recursos
computacionales disponibles.

Como puede observarse en los resultados de las diferentes combinaciones de
funciones y métodos realizadas en este trabajo, la optimización es todo un arte
donde la elección del método y la configuración de parámetros es fuertemente
dependiente de la forma de la función objetivo.

Tanto el algoritmo iterativo propuesto como el algoritmo de búsqueda de
dirección, acoplados a un método de fuerza bruta, han mostrado una adecuada
convergencia en las funciones objetivo analizadas, mejorando notablemente los
resultados de los métodos puros de fuerza bruta y de los algoritmos genéticos.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
