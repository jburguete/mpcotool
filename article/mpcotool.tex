...
optimization algorithms. Figure~\ref{FigSphereSWMCDS} displays the real convergence,
...
precision achieved.
%%%%%%%%%%%%%%%%%%%%%%
For the methods which utilized random numbers (MC, DS+RA y GE) 10 different
seeds for the pseudo-random number generator have been used. Figure (FALTA LA FIGURA!!!) 
shows, for these cases, the 
average value and the extreme values of the error norm obtained by these seeds. 
%%%%%%%%%%%%%%%%%%%%%%
...
Figure~\ref{FigSurcosSketch} displays the furrows geometry as well as the measurement points of the fertilizer 
concentration. 
