...
\subsection{Organización de CALIBRATOR}

La estructura con la que trabaja CALIBRATOR queda definida en el
\emph{input data file}, donde hay que especificar tanto el número  $N$ de
experimentos así como el número $n$ de ficheros de entrada que requiere el
programa de simulación. Además en este mismo fichero deben definirse los valores
que determinarán los parámetros empíricos y el algoritmo de optimización.
Entonces, CALIBRATOR lee las $N\times n$ plantillas con las que construir los
ficheros de entrada del simulador substituyendo etiquetas con los parámetros
empíricos creados por el algoritmo de optimización. El simulador puede bien
comparar directamente con el \emph{experimental data file} generando un fichero
con el valor de la función objetivo, o bien crear un fichero de resultados que
un programa externo denominado \emph{evaluator} comparará con el
\emph{experimenta data file} para generar el \emph{objective value file}.
...
}{Diagrama ilustrativo de las interacciones entre CALIBRATOR, los ficheros de
entrada, y los programas de simulación y evaluación}{FigStructure}
