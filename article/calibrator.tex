...
\begin{abstract}
A new tool, CALIBRATOR, is presented in this work as a software program to perform
calibrations or optimization of empirical parameters.
Due to its structure, CALIBRATOR can be easily adapted to many different simuLation codes.
