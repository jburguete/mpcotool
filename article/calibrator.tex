...
\newcommand{\CALIBRATOR}{Calibrator}
...
\subsection{Optimization analytical tests}
...
Esta se trata de la siguiente función cóncava de dos variables:
...
\subsubsection{Ackley's function}
...
\subsubsection{Rosenbrock's function}
