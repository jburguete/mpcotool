...
}{Channel cross sections}{FigCrossSections}
...
%%%%%%%%%%%%%%%%%%%%%%%%%
No obstante, se comprueba que el algoritmo iterativo aplicado a los métodos
de fuerza bruta ha incrementado ligeramente sus resultados en este caso. También
resulta destacable que el algoritmo genético ha obtenido el mejor y el peor de
los resultados, de donde se deduce que es un método cuyos resultados son
sensibles a los parámetros utilizados.
%%%%%%%%%%%%%%%%%%%%%%%%%
With the channel
...
the desired discharge at the different gates in Almudevar, Gurrea and El Temple is supplied,
