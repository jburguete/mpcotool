...
Además, los ancestros a partir de los que se generarán nuevos individuos entre
la población superviviente, CALIBRATOR utiliza la selección por defecto de
GENETIC que hace una elección aleatoria con una probabilidad linealmente
decreciente según su ordinal en el conjunto ordenado de individuos
supervivientes. En l
\PICTURE{250}{110}
{
	\put(10,20){\vector(0,1){80}}
	\put(10,20){\vector(1,0){235}}
	\put(0,102){Probability}
...
}{Probabilidad de que los individuos supervivientes sean seleccionados como
ancestros de los nuevos individuos generados por mutation, reproduction or
adaptation algorithms.}{FigSelection}

\subsubsection{Mutation algorithm}

En el algoritmo de mutación se elige un progenitor aleatoriamente 
una copia idéntica del del progenitor pero con un bit invertido elegido
aleatoriamente con probabilidad uniforme.
...
}{Ejemplo de la creación de un nuevo individuo por mutación}
{FigMutation}
...
}{Ejemplo de la creación de un nuevo individuo por reproducción. Nótese que los
bits iguales en ambos ancestros (en gris en el diagrama) se mantienen en el
hijo. El resto de los bits son aleatorios}{FigReproduction}
...
\PSPICTURE{-30}{-7.5}{80}{26}
{
	...
	\psframe(55,15)(57,20)
}{Ejemplo de la generación de un nuevo individuo a partir de un ancestro por
adaptación}{FigAdaptation}
