...
\begin{description}
	...
	\item[Monte-Carlo]: Monte-Carlo brute force algorithm. It requires on the main
		XML node:
		\begin{description}
			\item[simulations]: number of simulations to run for each iteration in
			every experiment.
		\end{description}
