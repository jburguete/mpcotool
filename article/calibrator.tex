...
laptop computer descrito anteriormente.
...
\TABLE{\scriptsize}{cccc}
{
	...
	\\ algorithm & parameters & parameters & value
	\\ \hline
	\multirow{2}{*}{Sweeps} & $N_{simulations}=400$
	& $k_1=0.263$
	& \multirow{2}{*}{0.01217} \\
	& $N_{iterations}=1$ & $k_2=0.105$
	\\ \hline
	\multirow{4}{*}{Sweeps} & $N_{simulations}=100$
	& $k_1=0.284$
	& \multirow{4}{*}{0.01217} \\
	...
	\\ & $tol=0.2$
	\\ \hline
	\multirow{3}{*}{Monte-Carlo} & $N_{simulations}=400$
	& $k_1=0.396$
	& \multirow{3}{*}{0.01219} \\
	& $N_{iterations}=1$ & $k_2=0.067$
	\\ & & $P=0.770$
	\\ \hline
	\multirow{4}{*}{Monte-Carlo} & $N_{simulations}=100$
	& $k_1=0.370$
	& \multirow{4}{*}{0.01215} \\
