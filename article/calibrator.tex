...
de 1000 simulaciones con diferentes algoritmos de optimización.
...
\TABLE{\scriptsize}{cccc}
{
	...
	\\ algorithm & parameters & parameters & value
	\\ \hline
	\multirow{3}{*}{Sweeps} & $N_{simulations}=1000$
	& $D_{50}=0.00378$
	& \multirow{3}{*}{0.00254} \\
	& $N_{iterations}=1$ & $n=17.778$
	\\ & & $P=0.556$
	\\ \hline
	\multirow{4}{*}{Sweeps} & $N_{simulations}=125$
	& $D_{50}=0.00350$
	& \multirow{4}{*}{0.00324} \\
	...
	\\ & $tol=0.4$
	\\ \hline
	\multirow{3}{*}{Monte-Carlo} & $N_{simulations}=1000$
	& $D_{50}=0.00307$
	& \multirow{3}{*}{0.00201} \\
	& $N_{iterations}=1$ & $n=21.513$
	\\ & & $P=0.770$
	\\ \hline
	\multirow{4}{*}{Monte-Carlo} & $N_{simulations}=125$
	& $D_{50}=0.00306$
	& \multirow{4}{*}{0.00160} \\
	...
	\\ & $tol=0.4$
	\\ \hline
	\multirow{5}{*}{genetic} & $N_{population}=250$
	& $D_{50}=0.00306$
	& \multirow{5}{*}{0.00171}
	...
	\\ & $R_{adaptation}=0.2$
	\\ \hline
	\multirow{5}{*}{genetic} & $N_{population}=100$
	& $D_{50}=0.00306$
	& \multirow{5}{*}{0.00162}
...
experimento de riego por aspersión en condiciones sin viento usando el programa
SURCOS y varios algoritmos de optimización implementados en CALIBRATOR con el
mismo número total de simulaciones}{TabSprinklerI}
