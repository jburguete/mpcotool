...
management.
%%%%%%%%%%%%
También se muestra la capacidad de MPCOTool de extraer la máxima potencia de
cálculo disponible paralelizando la optimización en un clúster de computadoras.
%%%%%%%%%%%%
\end{abstract}
