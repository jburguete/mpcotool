...
* 4.0.5: Stable and recommended version.
...
* 4.0.5/configure.ac: configure generator.
* 4.0.5/Makefile.in: Makefile generator.
* 4.0.5/config.h.in: config header generator.
* 4.0.5/\*.c: source code files.
* 4.0.5/\*.h: header code files.
* 4.0.5/mpcotool.ico: icon file.
* 4.0.5/build.sh: shell script to build all.
* 4.0.5/logo.png: logo figure.
* 4.0.5/Doxyfile: configuration file to generate doxygen documentation.
* TODO: tasks to do.
* README.md: this file.
...
On OpenSUSE Linux 15.3, in order to enable OpenMPI compilation, in 64 bits
...
you are in the directory mpcotool/4.0.5):
> $ cd ../tests/test2
>
> $ ln -s ../../../genetic/3.0.0 genetic
>
