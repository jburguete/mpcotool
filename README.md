...
* 3.4.1: Stable and recommended version.
...
* 3.4.1/configure.ac: configure generator.
* 3.4.1/Makefile.in: Makefile generator.
* 3.4.1/config.h.in: config header generator.
* 3.4.1/mpcotool.c: main source code.
* 3.4.1/mpcotool.h: main header code.
* 3.4.1/mpcotool.ico: icon file.
* 3.4.1/interface.h: interface header code.
* 3.4.1/build: script to build all.
* 3.4.1/logo.png: logo figure.
* 3.4.1/Doxyfile: configuration file to generate doxygen documentation.
* TODO: tasks to do.
* README.md: this file.
...
you are in the directory mpcotool/3.4.1):
> $ cd ../tests/test2
>
> $ ln -s ../../../genetic/2.2.1 genetic
>
