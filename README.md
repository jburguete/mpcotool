...
* 4.12.1: Stable and recommended version.
...
* 4.12.1/configure.ac: configure script generator.
* 4.12.1/Makefile.in: Makefile generator.
* 4.12.1/config.h.in: config header generator.
* 4.12.1/\*.c: C-source code files.
* 4.12.1/\*.h: C-header code files.
* 4.12.1/mpcotool.ico: icon file.
* 4.12.1/build.sh: shell script to build all.
* 4.12.1/logo.png: logo figure.
* 4.12.1/Doxyfile: configuration file to generate doxygen documentation.
* TODO: tasks to do.
