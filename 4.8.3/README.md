...
* 4.8.3: Stable and recommended version.
...
* 4.8.3/configure.ac: configure script generator.
* 4.8.3/Makefile.in: Makefile generator.
* 4.8.3/config.h.in: config header generator.
* 4.8.3/\*.c: C-source code files.
* 4.8.3/\*.h: C-header code files.
* 4.8.3/mpcotool.ico: icon file.
* 4.8.3/build.sh: shell script to build all.
* 4.8.3/logo.png: logo figure.
* 4.8.3/Doxyfile: configuration file to generate doxygen documentation.
* TODO: tasks to do.
...
you are in the directory mpcotool/4.8.3):
> $ cd ../tests/test2
>
> $ ln -s ../../../genetic/3.0.1 genetic
>
