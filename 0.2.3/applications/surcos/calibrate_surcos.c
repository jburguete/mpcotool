...
exit_simulation:
	...
	while (1);
exit_evaluate:
	return e / (maxy * maxy * nexperiment);
}
...
int main(int argn, char **argc)
{
	...
	ea = sqrt(evaluation(file_simulation, 3, 0, 1, file_experiment, 2, 0, 1));
	fclose(file_simulation);
	fclose(file_experiment);
	snprintf(buffer, 512, "%s/probes.out", argc[9]);
	file_simulation = fopen(buffer, "r");
	file_experiment = fopen(argc[4], "r");
	eh = sqrt(evaluation(file_simulation, 11, 0, 1, file_experiment, 2, 0, 1));
	fclose(file_simulation);
	fclose(file_experiment);
	snprintf(buffer, 512, "%s/probes.out", argc[9]);
	file_simulation = fopen(buffer, "r");
	file_experiment = fopen(argc[5], "r");
	es = evaluation(file_simulation, 11, 0, 4, file_experiment, 2, 0, 1);
	fclose(file_simulation);
	fclose(file_experiment);
	snprintf(buffer, 512, "%s/probes.out", argc[9]);
	file_simulation = fopen(buffer, "r");
	file_experiment = fopen(argc[6], "r");
	es += evaluation(file_simulation, 11, 0, 6, file_experiment, 2, 0, 1);
	fclose(file_simulation);
	fclose(file_experiment);
	snprintf(buffer, 512, "%s/probes.out", argc[9]);
	file_simulation = fopen(buffer, "r");
	file_experiment = fopen(argc[7], "r");
	es += evaluation(file_simulation, 11, 0, 8, file_experiment, 2, 0, 1);
	fclose(file_simulation);
	fclose(file_experiment);
	snprintf(buffer, 512, "%s/probes.out", argc[9]);
	file_simulation = fopen(buffer, "r");
	file_experiment = fopen(argc[8], "r");
	es += evaluation(file_simulation, 10, 0, 8, file_experiment, 2, 0, 1);
	fclose(file_simulation);
	fclose(file_experiment);
	es = sqrt(es / 4);
