...
* 4.6.2: Stable and recommended version.
...
* 4.6.2/configure.ac: configure script generator.
* 4.6.2/Makefile.in: Makefile generator.
* 4.6.2/config.h.in: config header generator.
* 4.6.2/\*.c: C-source code files.
* 4.6.2/\*.h: C-header code files.
* 4.6.2/mpcotool.ico: icon file.
* 4.6.2/build.sh: shell script to build all.
* 4.6.2/logo.png: logo figure.
* 4.6.2/Doxyfile: configuration file to generate doxygen documentation.
* TODO: tasks to do.
...
you are in the directory mpcotool/4.6.2):
> $ cd ../tests/test2
>
> $ ln -s ../../../genetic/3.0.1 genetic
>
