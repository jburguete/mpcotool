...
* 4.8.0: Stable and recommended version.
...
* 4.8.0/configure.ac: configure script generator.
* 4.8.0/Makefile.in: Makefile generator.
* 4.8.0/config.h.in: config header generator.
* 4.8.0/\*.c: C-source code files.
* 4.8.0/\*.h: C-header code files.
* 4.8.0/mpcotool.ico: icon file.
* 4.8.0/build.sh: shell script to build all.
* 4.8.0/logo.png: logo figure.
* 4.8.0/Doxyfile: configuration file to generate doxygen documentation.
* TODO: tasks to do.
...
you are in the directory mpcotool/4.8.0):
> $ cd ../tests/test2
>
> $ ln -s ../../../genetic/3.0.1 genetic
>
